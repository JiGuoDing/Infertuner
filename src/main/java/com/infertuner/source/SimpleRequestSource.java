 ...
 * 精简版请求数据源
 */
public class SimpleRequestSource implements SourceFunction<InferenceRequest> {
    
    private static final Logger logger = LoggerFactory.getLogger(SimpleRequestSource.class);
    ...
    public SimpleRequestSource() {
        this.maxRequests = 10;  // 只生成10个请求用于测试
        this.interval = 2000;   // 2秒间隔
    }
    
    public SimpleRequestSource(int maxRequests, long interval, boolean enableBurst) {
